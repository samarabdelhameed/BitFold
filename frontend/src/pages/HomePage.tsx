      ...
      <div className="relative z-10 min-h-screen flex flex-col items-center justify-center px-4">
        ...
        >
          ...
          <motion.button
            ...
            className="bg-gradient-to-r from-[#00D4FF] to-[#00FF85] text-[#0B0E11] px-12 py-4 rounded-full text-xl font-bold hover:shadow-lg hover:shadow-[#00D4FF]/50 transition-all"
          >
            Start Now
          </motion.button>
