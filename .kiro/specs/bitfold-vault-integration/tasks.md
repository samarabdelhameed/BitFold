...
- [x] 4. Implement ckBTC ledger integration
...
- [x] 5. Update API functions to use real integrations
...
- [x] 6. Implement helper functions and validation
...
- [x] 7. Implement state persistence for canister upgrades
...
- [x] 9. Implement query functions with proper filtering
...
- [x] 10. Add additional API functions for vault management
...
- [x] 12. Build and deploy to local dfx
  - [x] 12.1 Build vault canister
    - Run `dfx build vault`
